...
import com.keka.actioninterface.ActionInterface;
import com.keka.base.BaseClass;

public class Action extends BaseClass implements ActionInterface {

	// method to get all the xpath
	@Override
	public WebElement getElementsbyXpath(WebDriver driver, String xpath_element) {
		return driver.findElement(By.xpath(xpath_element));

	}

	@Override
	public WebElement getElementsbyID(WebDriver driver, String id_element) {
		return driver.findElement(By.id(id_element));

	}
	@Override
	public WebElement getElementsbyName(WebDriver driver, String name_element) {
		return driver.findElement(By.name(name_element));

	}

	@Override
	public List<WebElement> getListElementsbyXpath(WebDriver driver, String xpath_element) {
		return driver.findElements(By.xpath(xpath_element));

	}

	@Override
	public void getListElements(List<WebElement> listname) {

		System.out.println("List items are");
		for (WebElement webElemet : listname) {
			String list = webElemet.getText();
			System.out.println(list);
		}
	}

	@Override
	public void ListClick(List<WebElement> listname) {
	...
	@Override
	public void Multiselectcheckbox(List<WebElement> checkbox) {
	...
	@Override
	public void ThreadSleep(WebDriver driver, int timeOut) throws InterruptedException {
	...
	@Override
	public void fileuploadRobotClass(WebDriver driver, String filename) throws AWTException {
	...
	@Override
	public WebElement getList(WebDriver driver, WebElement ele) {
